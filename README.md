...
* ["Spark Getting Started Tutorial (Python Edition)" (http://dblab.xmu.edu.cn/blog/1709-2/)
...
* ["Avalanche weapon: Principle and use of fuse Hystrix"] (https://segmentfault.com/a/1190000005988895)
	...
	* Avalanche countermeasures: current limit, improved cache mode (cache preload, synchronous call to asynchronous), automatic expansion, and downgrade.
...
* [Relying on Governance, Grayscale Release, Fault Drilling, Design and Practical Experience of Ali E-Commerce Fault Walkthrough System] (https://mp.weixin.qq.com/s?__biz=MjM5MDE0Mjc4MA==&mid=2650996320&idx= 1&sn=0ed3be190bbee4a9277886ef88cbb2e5)
...
* ["Distributed Service Framework Study Notes 4 Service Routing"] (https://blog.csdn.net/xundh/article/details/59492750)
	...
	* Local routing priority policy: injvm (priority call jvm internal service), intermediate (prioritize the same physical machine service), in principle, find the nearest service.
...
> * Stealing or illegally obtaining the above information in other ways. If the circumstances are serious, the punishment shall be imposed in accordance with the provisions of the preceding paragraph. 
...
The "safe haven" principle means that when a copyright infringement case occurs, when the ISP (network service provider) only provides space services and does not create web content, if the ISP is notified of the infringement, there is an obligation to delete, otherwise it is regarded as infringement. . If the infringing content is not stored on the ISP's server and is not told which content should be deleted, the ISP does not assume tort liability. Later, the safe haven principle was also applied to search engines, network storage, online libraries and so on.
* ["The Safe Harbor Principles"] (https://baike.baidu.com/item/%E9%81%BF%E9%A3%8E%E6%B8%AF%E5%8E%9F%E5%88%99 /588459?fr=aladdin)
...
* "Taobao Technology for Ten Years" [Details] (https://www.coderxing.com/r.php?r=https://union-click.jd.com/jdc?d=CoUdGG)
